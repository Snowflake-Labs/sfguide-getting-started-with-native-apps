...
grant reference_usage on database NATIVE_APP_QUICKSTART_DB to share in application package HELLO_SNOWFLAKE_PACKAGE;
...
CREATE APPLICATION NATIVE_APP_QUICKSTART_APP FROM application package HELLO_SNOWFLAKE_PACKAGE using version 1 patch 0;
